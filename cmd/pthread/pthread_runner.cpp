...
int runPthread(string inputPath, string solutionPath, string parameterPath) {
    ...
    PthreadFitnessCalculator fitnessCalculator(params.threadNumber, genomeLength, problem, numVehicles, &keeper);
